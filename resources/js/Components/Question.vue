...
<template>
    <main class="pt-16  bg-white dark:bg-gray-900 antialiased">
        ...
        <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header class="mb-8 lg:mb-6 not-format">
                ...
                <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold"><img
                        ...
                        src="/storage/usr/1/avatar/1701703350avatar.webp"
                        alt="Незарегистрированный пользователь">Вы</p>
                <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-02-08"
                        title="February 8th, 2022">Только что</time></p>
            </div>
