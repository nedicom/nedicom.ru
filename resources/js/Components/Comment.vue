...
<article class="p-6 mb-3 text-base bg-white border-gray-200 dark:border-gray-700 dark:bg-gray-900">
        <footer class="flex justify-between items-center mb-2">
            <div class="flex items-center">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate="" datetime="2022-03-12" title="March 12th, 2022">Только что</time></p>
            </div>
            <!-- Dropdown menu -->
            <div id="dropdownComment3" class="hidden z-10 w-36 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(896px, 761.5px, 0px);" data-popper-placement="bottom">
