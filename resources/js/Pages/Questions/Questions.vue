...
<template>  
  ...
  <Body>
    <div class="bg-white py-12 ">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8   grid place-content-center">
        ...
        <div class="w-96 ">
          <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Старт сервиса с вопросами - 01 ноября 2023. ИИ оказался умнее многих юристов. Надо с этим что-то делать</p>             
          </div>
        </div>
      </div>
