        ...
        <div class="bg-white py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div
                        class="flex xl:flex-row flex-col items-center mb-2 mx-5"
                    >
                        <div
                            class="w-32 max-w-sm p-6 bg-white border mb-3 xl:mb-0 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
                        >
                            <svg
                        ...
                        <h5
                            class="flex w-full text-center items-center mx-5 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white"
                        >
                            Задайте вопрос, а мы с удовольствием ответим на него
                        </h5>
                    </div>
                    ...
                    <div class="p-5">
                        <form @submit.prevent="submit">
                            <div
                                class="grid grid-cols-1 xl:grid-cols-2 gap-4 p-5"
                            >
                                <div class="mb-3 w-full">
                                    ...
                                    <textarea
                                        ...
                                        name="body"
                                        rows="8"
                                        placeholder="Важно максимально точно задавать вопрос, чтобы было понятно как ответчать."
                                    ></textarea>
                                </div>
