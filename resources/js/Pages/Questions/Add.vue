              ...
              <form @submit.prevent="submit" >
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 p-5">  
                  ...
                  <textarea
                    ...
                    id=""
                    rows="2"
                    placeholder="Коротко о чем Ваш вопрос"
                  ></textarea>
                  <div
                    class="
                      my-1
