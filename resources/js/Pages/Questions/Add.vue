      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          ...
          <div class="group flex item-center mb-2">
              <div class="w-32 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <h5 class="flex items-center justify-center mx-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Задайте вопрос, а юристы с удовольствием ответят на него</h5>            
          </div>
