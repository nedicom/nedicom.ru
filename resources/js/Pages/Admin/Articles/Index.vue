            ...
            <table class="w-full whitespace-nowrap">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="border-t">
                          <button @click="handleDelete(articles.id, articles.header)" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1 text-center inline-flex items-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
  ...
  watch: {
    form: {
      ...
      handler: function (value) {
        this.$inertia.get('/admin/articles', { search: this.form.search })
      },
    },
  },
