...
<template>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 my-6 py-6">
        ...
        <div class="">
            <h2 class="my-6 py-6 text-3xl font-semibold text-grey text-center"><a :href="phoneto">{{ phone }}</a></h2>
            ...
            <h5 class="my-6 py-6 text-2xl font-semibold text-grey text-center">Консультирование ведется по предварительной записи</h5> 
            <div class="flex items-center justify-center">
                <p>
