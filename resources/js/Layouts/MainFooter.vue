<template>
    <footer class="p-4 bg-white rounded-lg shadow sticky top-[100vh] flex flex-col items-center mb-2 dark:bg-gray-800">
        <span class="text-sm text-gray-500 md:text-center md:w-full dark:text-gray-400">© 2024 <a href="https://nedicom.ru/" class="hover:underline">nedicom</a>™. Все права защищены.
        </span>
