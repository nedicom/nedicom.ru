                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                Польз<!-- {{ $page.props.auth.user.name }} -->
                                    ...
                                    <template  #content>
                                        <div v-if="$page.props.auth.user">                                                 
                                            ...
                                            <DropdownLink :href="route('articles/add')"> Добавить статью </DropdownLink>
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('articles')"> Статьи </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('articles/add')">Добавить статью</ResponsiveNavLink>
                        </div>
                    </div>
                </div>
            </nav>
